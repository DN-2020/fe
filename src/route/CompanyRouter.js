...
const CompanyRouter = (props) => {
  ...
  const getPreData = async () => {
    ...
    await setLogin(cookie)
  }
  return (
    <Layout style={{ minHeight: '100vh' }}>
      <Route path="/company">
        <CompanySider login={login}></CompanySider>
      </Route>
      <Layout className="site-layout">
        <Route path="/company">
          <CompanyHeader login={login}></CompanyHeader>
        </Route>
        <Route exact path="/company/dashboard" component={DashBoardContainer}></Route>
        <Route exact path="/company/login">
          <CompanyLogin login={login} setLogin={setLogin}></CompanyLogin>
        </Route>
        ...
        <Route exact path="/company/reservation" component={ResListContainer}></Route>
        <Route exact path="/company/review" component={ReviewListContainer} />
        <Route exact path="/company/review/:num" component={ReviewDetailContainer} />
        <Route exact path="/company/companys" component={Company} />
        <Route exact path="/company/companyDetail" component={CompanyDetail} />
        <Route exact path="/company/companyApprove" component={CompanyApprove} />
        <Route exact path="/company/companyApproveDetail" component={CompanyApproveDetail} />
        <Route exact path="/company/employee" component={Employee} />
        <Route exact path="/company/employeeRegister" component={EmployeeRegister} />
        <Route exact path="/company/employeeDetail/:num" component={EmployeeDetail} />
        <Route exact path="/company/department" component={Department} />
        <Route exact path="/company/departmentRegister" component={DepartmentRegister} />
        <Route exact path="/company/departmentDetail/:num" component={DepartmentDetail} />
