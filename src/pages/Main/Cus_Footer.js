...
const Cus_Footer = (props) => {
  ...
  return (
    <div className="cus_footer" style={{ marginTop: '4%', borderTop: '0.1px solid lightgray' }}>
      <div
        style={{
          display: 'flex',
      ...
      >
        ...
        >
          ...
          <h3>1588-0000</h3>
          <h3>
            월~금: 09:00~18:00 (점심시간 12:00~13:00) 공휴일 : 1:1 채팅 상담만 가능 환불, 변경 접수:
            월~금 09:00~17:00
          </h3>
      ...
      >
        <div
          style={{ width: '50%', display: 'flex', justifyContent: 'flex-start', marginTop: '1%' }}
        >
        ...
        >
          <Button onClick={() => history.push('/company')}>관리자 콘솔</Button>
        </div>
      </div>
    </div>
  )
