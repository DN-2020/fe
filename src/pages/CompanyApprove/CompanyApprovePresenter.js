...
const CompanyApprovePresenter = (props) => {
  return (
    <>
    ...
    <Column
      ...
      render={(text, record) => (
        <Space size="middle">
          ...
          <a href="http://localhost:3000/companyApproveDetail"><Button>상세</Button></a>
        </Space>
      )}
    />
  </Table>
...
CompanyApprovePresenter.propTypes = {
...
export default CompanyApprovePresenter
